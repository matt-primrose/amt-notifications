...
function startEvents(){
    ...
    let transport = startHTTP(config.port, notify.connectionHandler, output);
...
function startHTTP(port, connectionHandler, consoleLog){
    let server = httpserver(port, connectionHandler, consoleLog);
